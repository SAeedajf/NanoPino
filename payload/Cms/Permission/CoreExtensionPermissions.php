...
final class CoreExtensionPermissions
{
    public static function register(ExtensionPermissionRegistry $registry): void
    {
        $items = [
            ...
            ['content.submit_review', 'Submit CMS content for editorial review.', ExtensionPermissionRisk::Medium],
            ['content.approve', 'Approve CMS content for publication.', ExtensionPermissionRisk::High],
            ['content.archive', 'Archive published or approved CMS content.', ExtensionPermissionRisk::High],
