...
return [
    ...
    'media_page' => [
        ...
        'loading_library'=>'Loading media library…','load_failed'=>'Media library could not be loaded','load_failed_hint'=>'Unknown data is not shown as an empty library. Review the error or retry.','not_found'=>'No media found','filtered_empty'=>'Change the filters or upload a new file.','first_upload'=>'Upload the first file through the secure MediaService path.','no_alt'=>'No alt','previous'=>'Previous','next'=>'Next','range'=>'Showing :from to :to of :total',
