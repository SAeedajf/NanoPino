...
const fallback = {
  ...
  healthCenter: {
    ...
    kernel: {
      ...
      compatibility: { compatible: false, minimum: { code: 216, version: '3.10.0' }, current: { code: null, version: null }, optional_features_unavailable: [], primitives: [] },
    },
  },
  developerSdk: {
    version: 'v1',
    minimum: { php: '>=8.2', pincore: '>=3.10.0', kernelCode: 216, cms: '>=0.21.0', luma: '>=0.4.10' },
