    ...
    public static function definition(): array
    {
        return [
            ...
            'routes' => [
                ...
                self::route('GET','/themes/design',[ThemeRuntimeApiController::class,'design'],'cms.themes.design','themes.read','cms.api.read'),
                ...
                self::route('POST','/themes/wordpress/preview',[ThemeRuntimeApiController::class,'wordpressPreview'],'cms.themes.wordpress.preview','themes.install','cms.upload.extension',true),
                self::route('POST','/themes/wordpress/install',[ThemeRuntimeApiController::class,'wordpressInstall'],'cms.themes.wordpress.install','themes.install','cms.upload.extension',true),
