...
return [
    ...
    'nav' => [
        'dashboard' => 'Dashboard', 'content' => 'Content', 'content_index' => 'Content management', 'taxonomies' => 'Categories & tags', 'revisions' => 'Revisions', 'media' => 'Media',
    ...
    'routes' => [
        ...
        'taxonomies' => ['title' => 'Categories & tags', 'lead' => 'Manage taxonomy terms, hierarchy, slugs and content relations'],
    ...
    'dashboard' => [
        ...
        'partial_load_failed'=>':count dashboard section(s) could not be loaded; healthy data is still shown.',
        ...
        'inventory_hint'=>'Current comparison of resources read from the control plane',
        'inventory_aria'=>'Current NanoPino resource comparison chart',
    ],

    'system_page' => [
        'health_history'=>'Health history','health_history_empty'=>'No historical health snapshot has been recorded yet.',
        'refresh_health'=>'Refresh health','logs'=>'System logs','recovery'=>'Recovery & Safe Mode','technical_details'=>'Technical details','partial_load_failed'=>':count system section(s) could not be loaded; healthy data is still shown.',
        'operational_status'=>'Operational status','active_errors'=>'Active or recent errors','historical_errors'=>'Historical errors','recent_errors'=>':count recent errors','checking'=>'Checking…','active_window_note'=>'Based on the last 15 minutes','historical_note'=>'Retained for audit and historical review','structured_note'=>'Redacted and correlation-aware','health_checks'=>'Health checks','structured_logs'=>'Structured logs','checks_count'=>'checks','php'=>'PHP','pinoox'=>'Pinoox','cms'=>'CMS','health'=>'Health','memory'=>'Memory','disk'=>'Disk','database'=>'Database','cache'=>'Cache','storage'=>'Storage','scheduler'=>'Scheduler','queue'=>'Queue','extensions'=>'Extensions','kernel_compatibility'=>'Kernel compatibility','security_posture'=>'Security posture',
    ],    'security_page' => [
        'pass'=>'Pass','warning'=>'Warning','fail'=>'Fail','unknown'=>'Unknown','posture_title'=>'Security posture','posture_healthy'=>'All runtime security controls are active and reporting healthy.','posture_note'=>'Implemented policy is not the same as runtime binding; Warning means the control is ready but is not yet bound and E2E-verified on real Pinoox.',
        'runtime_gates'=>'Runtime gates','csrf_verifier'=>'CSRF verifier','rate_limits'=>'Rate limits','security_headers'=>'Security headers','ssrf_transport'=>'SSRF guarded transport','implicit_platform_super'=>'Implicit platform super','bound'=>'Bound','unbound'=>'Unbound','registered'=>'Registered','database_fallback'=>'Inactive (database fallback)','enabled'=>'Enabled','disabled'=>'Disabled',
        'platform_super_transition'=>'Platform super transition','platform_accounts'=>'Platform accounts','explicit_super_accounts'=>'Explicit super accounts','implicit_only_accounts'=>'Implicit-only accounts','transition_readiness'=>'Transition readiness','cutover_complete'=>'Explicit-role cutover complete','ready_for_cutover'=>'Ready for controlled cutover','not_safe_to_disable'=>'Not safe to disable','cutover_note'=>'Implicit platform-wide super access is disabled. All detected platform accounts have an explicit super role/group; keep the target admin session verified during future role changes.','cutover_guard_note'=>'NanoPino does not disable platform_super automatically. A controlled cutover is allowed only after every detected platform account has an explicit super role/group and the target admin session is verified.',
        'rate_limit_profiles'=>'Rate limit profiles','profile'=>'Profile','attempts'=>'Attempts','window_seconds'=>'Window (s)','key'=>'Key','api_security_matrix'=>'API security matrix','csrf_required'=>'CSRF required','safe_read'=>'Safe read','site_scope'=>'Site scope','global_system'=>'Global/System',
    ...
    'performance_page' => [
        'budget'=>'Budget','queries'=>'Queries','memory'=>'Memory','runtime'=>'Performance runtime','query_probe'=>'Query probe','cache_telemetry'=>'Cache telemetry','extension_cost'=>'Extension cost','recent_samples'=>'Recent samples','live'=>'Live','unbound'=>'Unbound','budget_heading'=>'Performance budgets — :profile','database_n_plus_one'=>'Database and N+1','query_count'=>'Query count','total_db_time'=>'Total DB time','n_plus_one_findings'=>'N+1 findings','slow_queries'=>'Slow queries','cache_effectiveness'=>'Cache effectiveness','metric'=>'Metric','measured'=>'Measured','target'=>'Target','limit'=>'Limit','status'=>'Status','pass'=>'Pass','fail'=>'Fail','warning'=>'Warning','unmeasured'=>'Unmeasured','profile_shared_hosting'=>'Shared hosting',
    ...
    'blocks_page' => [
        ...
        'time'=>'Time (UTC)','search'=>'Search audit events','action'=>'Action','owner'=>'Owner','actor'=>'Actor','outcome'=>'Outcome','target'=>'Target','correlation'=>'Correlation ID','scope'=>'Scope',
    ...
    'sdk_page' => [
        ...
        'starter_note'=>'Seven starter paths are available. File generation is an explicit developer command outside the admin panel.','starter_unbound'=>'The starter catalog is not bound to Runtime.','starter_executable'=>'Executable starter','starter_files'=>':count files','starter_validation'=>'Validation: :value',
    ],
    'updates_page' => [
        'extension'=>'Extension','select_extension'=>'Select extension','select_extension_hint'=>'Select an extension to load its policy, history, and recovery points.','saving'=>'Saving…','saved'=>'Update policy saved.','partial_load_failed'=>':count update section(s) could not be loaded; healthy data is still shown.',
    ...
    'content_page' => [
        'refresh'=>'Refresh','add'=>'Add content','operation_failed'=>'Operation failed','current_view'=>'Current view','published'=>'Published','draft'=>'Draft','pending_review'=>'Pending review','approved'=>'Approved','archived'=>'Archived','workflow_title'=>'Editorial workflow','workflow_help'=>'Move content from draft through review and approval before publishing; archive keeps its history.','workflow_status'=>'Current stage','workflow_steps_aria'=>'Editorial workflow stages','workflow_draft_hint'=>'Authoring and local changes','workflow_review_hint'=>'Waiting for editorial review','workflow_approval_hint'=>'Approved for release','workflow_publish_hint'=>'Visible on the public site','workflow_archive_hint'=>'Retained outside active publishing',
        'edit'=>'Edit :type #:id','add_type'=>'Add :type','title'=>'Title','title_placeholder'=>'Content title','excerpt'=>'Excerpt','ids_csv'=>'Separate IDs with commas','multiple'=>'Multiple values','advanced'=>'Advanced settings','metadata_json'=>'Metadata JSON',
    ...
    'taxonomies_page' => [
        'taxonomy'=>'Taxonomy','terms'=>'Terms','search'=>'Search','search_placeholder'=>'Name or slug…','refresh'=>'Refresh','term_count'=>':count terms','hierarchical'=>'Hierarchical','flat'=>'Flat','loading'=>'Loading terms…','empty_title'=>'No terms found','empty_message'=>'Create the first category or tag to get started.','parent'=>'Parent #:id','edit'=>'Edit','delete'=>'Delete','edit_term'=>'Edit term','add_term'=>'Add term','name'=>'Name','slug'=>'Slug','slug_placeholder'=>'Generated from the name when empty','description'=>'Description','parent_term'=>'Parent term','no_parent'=>'No parent','save'=>'Save','saving'=>'Saving…','cancel'=>'Cancel','read_only'=>'This page is read-only; taxonomy.manage is required to change terms.','created'=>'Term created.','updated'=>'Term updated.','deleted'=>'Term deleted.','delete_confirm'=>'Delete “:name”?','previous'=>'Previous','next'=>'Next','range'=>':from to :to of :total',
    ],
    ...
    'recovery_page' => [
        ...
        'restore_requested'=>'Restore request sent.','restoring'=>'Restoring…','disable_requested'=>'Safe Mode exit request sent.','requesting'=>'Sending request…','dismiss_error'=>'Dismiss error','action_failed'=>'The recovery operation failed.',
    ...
    'common' => [
        'error_reference' => 'Tracking ID',
        'authentication_required' => 'Your session has expired or authentication is required. Sign in again.',
        'access_denied' => 'Your account does not have permission to perform this action.',
        'api_unconfirmed' => 'The server response could not be confirmed. Check the current state before retrying.',
        'request_timeout' => 'The server took too long to respond. Check the connection and try again.',
