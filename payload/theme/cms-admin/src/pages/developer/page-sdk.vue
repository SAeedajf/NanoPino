...
function typeLabel(value) {
  return ({
    ...
    'admin-extension': t('extensions_page.type_admin_extension'),
    block: t('extensions_page.type_block'),
    'block-package': t('extensions_page.type_block_package'),
    driver: t('extensions_page.type_driver'),
    'language-pack': t('extensions_page.type_language_pack'),
  })[value] || value || '—'
}
