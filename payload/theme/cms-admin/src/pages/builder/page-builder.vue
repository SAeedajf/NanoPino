  ...
  <LPage icon="panels-top-left" class="cms-builder-page">
    <template #actions>
      <div class="cms-card-actions">
        ...
        <LButton icon="file-plus-2" variant="outline" shape="rounded" :disabled="busy||!canEdit||!!record" @click="createDocument">{{ t('builder_page.create_override') }}</LButton>
