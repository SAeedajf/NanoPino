...
final class SecurityRuntimeApiController extends ApiController
{
 public function index():JsonResponse
 {
  ...
  $runtime=new SecurityRuntimeState(RuntimeBindingState::csrf(),RuntimeBindingState::rateLimits(),RuntimeBindingState::headers(),RuntimeBindingState::ssrf(),RuntimeBindingState::api(),RuntimeBindingState::csp());
